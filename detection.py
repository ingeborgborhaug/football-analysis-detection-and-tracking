...
# model = YOLO('football-analysis-detection-and-tracking/runs/detect/train17/weights/best.pt')
...
# start = datetime.now()
# results_training = model.train(data= LOCAL_PATH + "/data.yaml", epochs=300, imgsz=IMG_SIZE, dropout=0.3, patience=100, plots=True)
# end = datetime.now()
