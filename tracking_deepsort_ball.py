...
for max_age, n_init, max_iou_distance in param_combinations:
    ...
    for image_path in sorted(Path(TEST_IMAGES_PATH).glob("*.jpg")):
        ...
        for data in detections.boxes.data.tolist():
            ...
            if class_id == 1: # Skip if not ball
                continue
    ...
    recall = summary.loc['Tracking']['recall']
...
print(f"Best MOTA: {best_recall:.4f} with params: max_age={best_params[0]}, n_init={best_params[1]}, max_iou_distance={best_params[2]}")
